...
export const daoAccessFlagsMap: Record<string, string> = {
  ...
  INCREASE_INVESTOR_CAP_ID: "INCREASE_INVESTOR_CAP_ID",
  INCREASE_GOVERNOR_MEMBERSHIP_ID: "INCREASE_GOVERNOR_MEMBERSHIP_ID",
  INCREASE_INVESTOR_MEMBERSHIP_ID: "INCREASE_INVESTOR_MEMBERSHIP_ID",
  INCREASE_VOTING_ID: "INCREASE_VOTING_ID",
  INCREASE_FEE_ID: "INCREASE_FEE_ID",
  INCREASE_POLL_FOR_INVESTMENT_ID: "INCREASE_POLL_FOR_INVESTMENT_ID",
  INCREASE_PROPOSER_MEMBERSHIP_ID: "INCREASE_PROPOSER_MEMBERSHIP_ID",
