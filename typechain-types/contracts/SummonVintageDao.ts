...
export declare namespace SummonVintageDao {
  ...
  export type VintageParticipantCapInfoStruct = {
    enable: PromiseOrValue<boolean>;
    cap: PromiseOrValue<BigNumberish>;
  };

  export type VintageParticipantCapInfoStructOutput = [boolean, BigNumber] & {
    enable: boolean;
    cap: BigNumber;
  };
  ...
  export type VintageRaiserMembershipStruct = {
    enable: PromiseOrValue<boolean>;
    varifyType: PromiseOrValue<BigNumberish>;
    minAmount: PromiseOrValue<BigNumberish>;
    tokenAddress: PromiseOrValue<string>;
  ...
  export type VintageRaiserMembershipStructOutput = [
    boolean,
    number,
    BigNumber,
    string,
  ...
  export type VintageDaoParamsStruct = {
    ...
    participantCap: SummonVintageDao.VintageParticipantCapInfoStruct;
    backerMembership: SummonVintageDao.VintageBackerMembershipStruct;
    raiserMembership: SummonVintageDao.VintageRaiserMembershipStruct;
    votingInfo: SummonVintageDao.VintageVotingInfoStruct;
    genesisRaisers: PromiseOrValue<string>[];
  ...
  export type VintageDaoParamsStructOutput = [
    ...
    DaoFactory.AdapterStructOutput[],
    SummonVintageDao.VintageParticipantCapInfoStructOutput,
    SummonVintageDao.VintageBackerMembershipStructOutput,
    SummonVintageDao.VintageRaiserMembershipStructOutput,
    ...
    participantCap: SummonVintageDao.VintageParticipantCapInfoStructOutput;
    backerMembership: SummonVintageDao.VintageBackerMembershipStructOutput;
    raiserMembership: SummonVintageDao.VintageRaiserMembershipStructOutput;
    votingInfo: SummonVintageDao.VintageVotingInfoStructOutput;
    genesisRaisers: string[];
...
export interface SummonVintageDao extends BaseContract {
  ...
  functions: {
    ...
    summonVintageDao5(
      ...
      vintageDaoRaiserMembershipWhitelist: PromiseOrValue<string>[],
      newDaoAddr: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
