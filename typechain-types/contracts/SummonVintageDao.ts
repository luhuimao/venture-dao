...
export declare namespace SummonVintageDao {
  ...
  export type VintageInvestorMembershipStruct = {
    enable: PromiseOrValue<boolean>;
  ...
  export type VintageInvestorMembershipStructOutput = [
    boolean,
    string,
    number,
    BigNumber,
  ...
  export type VintageDaoParamsStruct = {
    ...
    investorMembership: SummonVintageDao.VintageInvestorMembershipStruct;
  ...
  export type VintageDaoParamsStructOutput = [
    ...
    SummonVintageDao.VintageInvestorMembershipStructOutput,
    ...
    investorMembership: SummonVintageDao.VintageInvestorMembershipStructOutput;
...
export interface SummonVintageDaoInterface extends utils.Interface {
  functions: {
    ...
    "summonVintageDao((string,address,address[],(bytes32,address,uint128)[],(bytes32,address,uint128)[],(bool,uint256),(bool,string,uint8,uint256,address,uint256,address[]),(bool,string,uint8,uint256,address,uint256,address[]),(uint256,address,uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256),address[],uint256[],address))": FunctionFragment;
    ...
    "summonVintageDao5(bool,string,uint256[3],address,address[],address)": FunctionFragment;
    "summonVintageDao6(address,address,address,uint256[9])": FunctionFragment;
    "summonVintageDao7(address,uint256,address[],uint256[])": FunctionFragment;
    "summonVintageDao8(bool,address,string,uint8,uint256,uint256,address,address[])": FunctionFragment;
