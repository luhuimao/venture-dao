...
export interface ICollectiveVestingInterface extends utils.Interface {
  functions: {
...
export interface ICollectiveVesting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICollectiveVestingInterface;
