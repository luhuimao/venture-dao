...
export interface ICollectiveVotingInterface extends utils.Interface {
  functions: {
...
export interface ICollectiveVoting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ICollectiveVotingInterface;
