...
export interface ColletiveSetRiceReceiverProposalAdapterContractInterface
  ...
  functions: {
    ...
    "summbitProposal(address,address)": FunctionFragment;
  };
...
export interface ColletiveSetRiceReceiverProposalAdapterContract
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ColletiveSetRiceReceiverProposalAdapterContractInterface;
