...
export interface CollectiveVestingContractInterface extends utils.Interface {
  functions: {
...
export interface CollectiveVestingContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollectiveVestingContractInterface;
