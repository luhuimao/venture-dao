...
export interface CollectiveVotingContractInterface extends utils.Interface {
  functions: {
...
export interface CollectiveVotingContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollectiveVotingContractInterface;
