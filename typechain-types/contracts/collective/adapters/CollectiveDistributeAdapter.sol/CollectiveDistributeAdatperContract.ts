...
export interface CollectiveDistributeAdatperContractInterface
...
export interface CollectiveDistributeAdatperContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollectiveDistributeAdatperContractInterface;
