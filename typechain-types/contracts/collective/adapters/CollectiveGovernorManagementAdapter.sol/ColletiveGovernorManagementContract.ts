...
export interface ColletiveGovernorManagementContractInterface
  ...
  functions: {
    ...
    "submitGovernorInProposal(address,address,address,uint256)": FunctionFragment;
...
export interface ColletiveGovernorManagementContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ColletiveGovernorManagementContractInterface;
