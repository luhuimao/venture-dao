...
export interface CollectiveFreeInEscrowFundAdapterContractInterface
...
export interface CollectiveFreeInEscrowFundAdapterContract
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollectiveFreeInEscrowFundAdapterContractInterface;
