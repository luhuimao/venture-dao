...
export interface ColletiveExpenseProposalAdapterContractInterface
  ...
  functions: {
    ...
    "summbitProposal(address,address,address,uint256)": FunctionFragment;
  };
...
export interface ColletiveExpenseProposalAdapterContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ColletiveExpenseProposalAdapterContractInterface;
