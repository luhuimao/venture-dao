...
export interface ColletiveFundRaiseProposalAdapterContractInterface
  extends utils.Interface {
  functions: {
    "allDone(address)": FunctionFragment;
    "fundRaisingId(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "fundRaisingId",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface ColletiveFundRaiseProposalAdapterContract
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ColletiveFundRaiseProposalAdapterContractInterface;
