...
export interface CollectiveFundingPoolFactoryInterface extends utils.Interface {
  functions: {
...
export interface CollectiveFundingPoolFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CollectiveFundingPoolFactoryInterface;
