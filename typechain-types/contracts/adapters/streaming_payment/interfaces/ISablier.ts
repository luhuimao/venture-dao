...
export interface ISablierInterface extends utils.Interface {
  functions: {
    "balanceOf(uint256,address)": FunctionFragment;
    "createStream(address,address,bytes32)": FunctionFragment;
  ...
  events: {
    "CreateStream(uint256,address,address,bytes32,uint256,address,uint256,uint256)": EventFragment;
...
export type CreateStreamEvent = TypedEvent<
  [BigNumber, string, string, string, BigNumber, string, BigNumber, BigNumber],
...
export interface ISablier extends BaseContract {
  ...
  filters: {
    "CreateStream(uint256,address,address,bytes32,uint256,address,uint256,uint256)"(
