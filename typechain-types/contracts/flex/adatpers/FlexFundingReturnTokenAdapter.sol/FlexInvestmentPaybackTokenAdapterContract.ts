...
export interface FlexInvestmentPaybackTokenAdapterContractInterface
...
export interface FlexInvestmentPaybackTokenAdapterContract
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlexInvestmentPaybackTokenAdapterContractInterface;
