...
export interface FlexFundingAdapterContractInterface extends utils.Interface {
  functions: {
    ...
    "getPriorityDepositedWhitelist(address,bytes32)": FunctionFragment;
    "getProposerWhitelist(address)": FunctionFragment;
    "isActiveMember(address,address)": FunctionFragment;
    "isPriorityDepositedWhitelist(address,bytes32,address)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getPriorityDepositedWhitelist"
      | "getProposerWhitelist"
      | "isActiveMember"
      | "isPriorityDepositedWhitelist"
      | "isProposerWhiteList"
      | "processProposal"
      | "protocolAddress"
      | "protocolFee"
  ...
  encodeFunctionData(
    functionFragment: "getPriorityDepositedWhitelist",
    values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isPriorityDepositedWhitelist",
    values: [
