...
export interface FlexSetRiceReceiverProposalAdapterContractInterface
  ...
  events: {
    "ProposalCreated(address,bytes32,uint256)": EventFragment;
...
export interface FlexSetRiceReceiverProposalAdapterContract
  extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlexSetRiceReceiverProposalAdapterContractInterface;
  ...
  filters: {
    "ProposalCreated(address,bytes32,uint256)"(
      daoAddr?: null,
      proposalId?: null,
      stopVoteTime?: null
