...
export interface FlexAllocationAdapterContractInterface
  ...
  functions: {
    ...
    "getInvestmentRewards(address,bytes32,address)": FunctionFragment;
    "getNoEscrowInvestmentShare(address,bytes32,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getNoEscrowInvestmentShare",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<BytesLike>,
      PromiseOrValue<string>
