...
export interface FlexVotingContractInterface extends utils.Interface {
  functions: {
    "ADAPTER_NAME()": FunctionFragment;
    "checkIfVoted(address,bytes32,address)": FunctionFragment;
    "getAdapterName()": FunctionFragment;
    "getAllStewardWeight(address)": FunctionFragment;
    "getAllStewardWeightByProposalId(address,bytes32)": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "getAdapterName"
      | "getAllStewardWeight"
      | "getAllStewardWeightByProposalId"
      | "getSenderAddress"
      | "getVotingWeight"
      | "isActiveMember"
  ...
  encodeFunctionData(
    functionFragment: "getAllStewardWeight",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "getAllStewardWeightByProposalId",
...
export interface FlexVotingContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlexVotingContractInterface;
