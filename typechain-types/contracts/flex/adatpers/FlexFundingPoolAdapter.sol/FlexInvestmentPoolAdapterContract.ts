...
export interface FlexInvestmentPoolAdapterContractInterface
  ...
  functions: {
    ...
    "createInvestorMembership(address,string,uint8,uint256,address,uint256)": FunctionFragment;
    ...
    "getInvestorMembershipInfo(address,string)": FunctionFragment;
    ...
    "isInvestorWhiteList(address,string,address)": FunctionFragment;
    "isPriorityDepositWhitelist(address,address)": FunctionFragment;
    "registerInvestorWhiteList(address,string,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getInvestorMembershipInfo",
    values: [PromiseOrValue<string>, PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
