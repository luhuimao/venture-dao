...
export interface VintageAllocationAdapterContractInterface
  ...
  functions: {
    ...
    "getFundingRewards(address,address,uint256)": FunctionFragment;
...
export interface VintageAllocationAdapterContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VintageAllocationAdapterContractInterface;
