...
export interface VintageSetRiceReceiverAdapterContractInterface
...
export interface VintageSetRiceReceiverAdapterContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VintageSetRiceReceiverAdapterContractInterface;
