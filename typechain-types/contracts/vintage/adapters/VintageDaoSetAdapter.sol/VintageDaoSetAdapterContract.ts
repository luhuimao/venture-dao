...
export declare namespace VintageDaoSetAdapterContract {
  ...
  export type InvesotrMembershipParamsStruct = {
    dao: PromiseOrValue<string>;
    name: PromiseOrValue<string>;
    enable: PromiseOrValue<boolean>;
    varifyType: PromiseOrValue<BigNumberish>;
  ...
  export type InvesotrMembershipParamsStructOutput = [
    string,
    string,
    boolean,
    number,
...
export interface VintageDaoSetAdapterContractInterface extends utils.Interface {
  functions: {
    "getinvestorMembershipWhiteLists(bytes32)": FunctionFragment;
    ...
    "submitGovernorMembershipProposal((address,string,bool,uint8,uint256,address,uint256,address[]))": FunctionFragment;
    "submitInvestorCapProposal(address,bool,uint256)": FunctionFragment;
    "submitInvestorMembershipProposal((address,string,bool,uint8,uint256,address,uint256,address[]))": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | "getinvestorMembershipWhiteLists"
  ...
  encodeFunctionData(
    functionFragment: "getinvestorMembershipWhiteLists",
  ...
  encodeFunctionData(
    ...
    values: [VintageDaoSetAdapterContract.GovernorMembershipParamsStruct]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [VintageDaoSetAdapterContract.InvesotrMembershipParamsStruct]
  ): string;
  encodeFunctionData(
...
export interface VintageDaoSetAdapterContract extends BaseContract {
  ...
  functions: {
    ...
    submitGovernorMembershipProposal(
      params: VintageDaoSetAdapterContract.GovernorMembershipParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    submitInvestorMembershipProposal(
      params: VintageDaoSetAdapterContract.InvesotrMembershipParamsStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    votingProposals(
      ...
      [
        ...
        VintageDaoSetAdapterContract.VotingAssetInfoStructOutput,
        ...
        votingAssetInfo: VintageDaoSetAdapterContract.VotingAssetInfoStructOutput;
