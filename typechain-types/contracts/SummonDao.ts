...
export declare namespace SummonDao {
  ...
  export type FlexDaoGovernorMembershipInfoStruct = {
    enable: PromiseOrValue<boolean>;
    name: PromiseOrValue<string>;
    varifyType: PromiseOrValue<BigNumberish>;
    minHolding: PromiseOrValue<BigNumberish>;
  ...
  export type FlexDaoGovernorMembershipInfoStructOutput = [
    boolean,
    string,
    BigNumber,
    BigNumber,
  ...
  export type FlexDaoParamsStruct = {
    ...
    _flexDaoGovernorMembershipInfo: SummonDao.FlexDaoGovernorMembershipInfoStruct;
  ...
  export type FlexDaoParamsStructOutput = [
    ...
    SummonDao.FlexDaoGovernorMembershipInfoStructOutput,
    ...
    _flexDaoGovernorMembershipInfo: SummonDao.FlexDaoGovernorMembershipInfoStructOutput;
...
export interface SummonDaoInterface extends utils.Interface {
  functions: {
    ...
    "summonFlexDao((address[],(bytes32,address,uint128)[],(bytes32,address,uint128)[],bool,(bool,uint256),bool,(uint8,string,uint256,address,uint256,address[]),bool,(uint8,uint256,address,uint256,address[],uint256),(bool,string,uint256,uint256,address,uint256,address[]),(uint256,address,uint256,uint256,uint8,uint256,uint256,uint256,uint256),(uint8,string,uint256,address,uint256,address[]),(uint256,uint8,uint256,uint256,uint256,address,uint256,uint256,uint256),(bool,string,uint8,uint256,address,uint256,address[]),(string,address,uint256,uint256,address,address[],uint256[],address)))": FunctionFragment;
    ...
    "summonFlexDao5(uint256,address,uint256,address,uint8,uint256,address,uint256[6],address)": FunctionFragment;
    "summonFlexDao6(address[],uint256[],address,uint256)": FunctionFragment;
    "summonFlexDao7(bool[2],string,uint256[10],address[3],address[])": FunctionFragment;
    "summonFlexDao8(bool,bool,string[2],uint256[6],address[3],address[],address[])": FunctionFragment;
...
export interface SummonDao extends BaseContract {
  ...
  functions: {
    ...
    summonFlexDao7(
      ...
      flexPollVoterMembershipName: PromiseOrValue<string>,
    ...
    summonFlexDao8(
      ...
      stringParams: [PromiseOrValue<string>, PromiseOrValue<string>],
      uint256Params: PromiseOrValue<BigNumberish>[],
      addressParams: [
        PromiseOrValue<string>,
        PromiseOrValue<string>,
