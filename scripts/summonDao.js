...
async function main() {
    ...
    // await getCollectiveGovernorManagementProposalInfo("0xb99448986c9400e59a341fee31d85a9c3db02400",
    //     "0x31d85a9c3db02400476f7665726e6f722d496e23310000000000000000000000"
    // );
...
const getAdapterAddress = async () => {
    const daoContrct = (await hre.ethers.
        getContractFactory("DaoRegistry")).attach("0x90ea95b645e52c3e5c993ebbaca17efd6e763ac9");
