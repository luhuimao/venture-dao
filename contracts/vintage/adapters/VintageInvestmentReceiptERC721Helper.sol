...
import "./VintageInvestmentReceiptERC721.sol";
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";
import "@openzeppelin/contracts/utils/Strings.sol";

contract VintageInvestmentReceiptERC721Helper {
    ...
    function getSvg(
        ...
        (
            ...
            VintageInvestmentReceiptERC721.ERC20Info memory erc20,
            string memory projectName,
            ,

        ) = VintageInvestmentReceiptERC721(receiptNFTContrAddress)
